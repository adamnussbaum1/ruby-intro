...
favorite_foods = ["tacos", "coookies", "nachos", "ice cream"]
puts favorite_foods ## add .inspect to end to see how array is defined if needed
...
puts shopping_list [1][1] #second element of the second array, zero is technically index 1
